...
description: Decompose a multi-step task into a dependency-ordered table and execute one step per response. Use for "break down this task", "plan this". Not for single obvious steps.
---
